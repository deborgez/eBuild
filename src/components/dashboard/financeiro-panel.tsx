...
interface ResumoFinanceiro {
  ...
  totalPago: number
  totalPagoMaterial: number
  totalPagoMaoDeObra: number
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="stat-card">
          ...
          <div className="mt-2 pt-2 border-t flex justify-between text-xs" style={{ borderColor: 'var(--color-border)' }}>
            <span style={{ color: 'var(--color-text-muted)' }}>
              Material: <span className="font-semibold" style={{ color: 'var(--color-text-primary)' }}>{formatCurrency(financeiro.totalPagoMaterial)}</span>
            </span>
            <span style={{ color: 'var(--color-text-muted)' }}>
              Mão de obra: <span className="font-semibold" style={{ color: 'var(--color-text-primary)' }}>{formatCurrency(financeiro.totalPagoMaoDeObra)}</span>
            </span>
          </div>
        </div>
